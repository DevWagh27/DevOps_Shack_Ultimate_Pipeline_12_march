...
9. **Configure Security Group**:
   ...
   - 30000 - 32767 range for kubernetes cluster
   - 465 for sending mail through SMTP sever via Jenkins
   - 6443 required for setting  k8s cluster
   - 3000 - 10000 most of aplication eaisly deployed through this range
